...
/**
 * A TrainingSet contains a set of types, and for each type a corresponding set
 * of positive and negative examples. It used to train a TrainableClassifier.
 * 
...
public final class TrainingSet {
	...
	/**
	 * Add a example to this training set for the given type (either positive or
	 * negative, denoted by the "which" argument).
	 */
	...
	/**
	 * Return true if the training type with the specified name is in the set,
	 * or false otherwise.
	 */
