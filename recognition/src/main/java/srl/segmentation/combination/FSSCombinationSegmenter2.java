...
public class FSSCombinationSegmenter2 extends AbstractSegmenter implements
	 ...
	 * SBFS threshold
	 */
	private static final double S_THRESHOLD = 1.7637226;// 2.020747995;
	...
	private List<Segmentation> m_shortStrawSegs;

	private List<Segmentation> m_dpSegs;

	private List<Segmentation> m_sezginSegs;

	private List<Segmentation> m_paleoSegs;

	private List<Segmentation> m_kimSegs;
	...
	public List<Segmentation> getShortStrawSegs() {
		return m_shortStrawSegs;
	}

	public List<Segmentation> getDPSegs() {
		return m_dpSegs;
	}

	public List<Segmentation> getSezginSegs() {
		return m_sezginSegs;
	}

	public List<Segmentation> getPaleoSegs() {
		return m_paleoSegs;
	}

	public List<Segmentation> getKimSegs() {
		return m_kimSegs;
	}
	...
	public List<Segmentation> getSegmentations()
		...
		if (allCorners.size() > 100)
			return new ArrayList<Segmentation>();
